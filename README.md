## SolveReport Prototype

### **Prototype - Overview :**

- **Description:** 

  This prototype helps the user create a report from their clean CSV files in a few clicks.
  You have the control on the appearance, the components of your report, even without knowing how to code.
  ...
  Main purposes (Prototype) : 
     ...
     - to help and suggest in the report creation process
